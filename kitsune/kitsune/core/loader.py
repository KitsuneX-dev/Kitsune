...
class KitsuneModule:
    ...
    async def request_join(self, username: str, message: str = "") -> None:
        try:
            ...
            logger.info(f"KitsuneModule: Joined {username}")
        except Exception as e:
            logger.warning(f"KitsuneModule: Failed to join {username}: {e}")
    ...
    async def animate(self, chat_id: int, frames: list[str], interval: float = 0.5) -> None:
        for frame in frames:
            try:
                ...
                logger.warning(f"KitsuneModule: Animate error: {e}")
                break
    ...
    async def get_chats(self) -> list:
        try:
            ...
            logger.warning(f"KitsuneModule: get_chats error: {e}")
            return []
    ...
    async def get_chat(self, chat_id: int | str):
        try:
            ...
            logger.warning(f"KitsuneModule: get_chat error: {e}")
            return None
    ...
    async def delete_chat(self, chat_id: int) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: delete_chat error: {e}")
            return False
    ...
    async def get_user(self, user_id: int | str):
        try:
            ...
            logger.warning(f"KitsuneModule: get_user error: {e}")
            return None
    ...
    async def invite_to_chat(self, chat_id: int, user_id: int) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: invite_to_chat error: {e}")
            return False
    ...
    async def kick_from_chat(self, chat_id: int, user_id: int) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: kick_from_chat error: {e}")
            return False
    ...
    async def mute_chat(self, chat_id: int, mute: bool = True) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: mute_chat error: {e}")
            return False
    ...
    async def pin_message(self, chat_id: int, message_id: int, both: bool = False) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: pin_message error: {e}")
            return False
    ...
    async def unpin_message(self, chat_id: int, message_id: int | None = None) -> bool:
        try:
            ...
            logger.warning(f"KitsuneModule: unpin_message error: {e}")
            return False
