...
Kitsune — userbot для Telegram, который живёт прямо на твоём устройстве. Никаких облаков, никаких посредников. Двойной клиентский стек (Telethon + Hydrogram), AST-сканер модулей, зашифрованные бэкапы и интерактивный конфигуратор — всё из коробки.
...
| 📦 | Авто-бэкап | Зашифрованные резервные копии по расписанию |
